...
Public Class ObstacleManager
    ...
    Private spawnDelay As Integer = 100         ' Intervalo base entre spawns (en frames)
    ...
    Private random As New Random()              ' Generador para dimensiones aleatorias
    ...
    Public Sub Update(gameSpeed As Single)
        ...
        ' A mayor velocidad, menor intervalo entre obstáculos (más difícil)
        Dim adjustedDelay As Integer = CInt(spawnDelay / gameSpeed)
    ...
    ' Crea un nuevo obstáculo con características aleatorias
    ' gameSpeed: Velocidad actual del juego para ajustar velocidad del obstáculo
    Private Sub SpawnObstacle(gameSpeed As Single)
        ' Generar dimensiones aleatorias para variedad visual
        Dim width As Integer = 20 + random.Next(0, 20)     ' Ancho: 20-39 píxeles
        Dim height As Integer = 40 + random.Next(0, 30)    ' Alto: 40-69 píxeles
        ...
        obstacles.Add(New Obstacle(screenWidth, groundY - height, width, height, currentSpeed))
    End Sub
